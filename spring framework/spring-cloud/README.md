...
Spring Cloud资源 ： https://www.springcloud.cc/

本文文章来自：https://zhuanlan.zhihu.com/p/95696180?from_voters_page=true 

备注：这篇文章写的太好了，以至于没有必要在此之上加修改。如果有违背作者意愿，请及时联系
...
Spring Cloud包含的产品以及对应的功能

![](1.jpg)

<center>图1 Spring Cloud 产品功能 </center>
...
<center>图2 Spring Cloud 微服务总体架构</center>

服务提供方(Provider)和服务调用方(Consumer)都需要向注册中心(Registry center)注册服务，其中服务方向注册中心注册是为了服务的发布，服务调用方向注册中心注册是为了服务的发现。

在服务提供方向注册中心注册的时候，可能会从配置中心拉取配置；配置中心会提供相应的控制台或者接口来更新配置，这时配置更改时会将变化发送消息到消息总线(bus，这里的消息总线可以用消息队列实现)，服务提供方接收消息从而更改自己的配置，这样的优点是服务提供方不需要重新上线。
...
1. https://zhuanlan.zhihu.com/p/95696180
2. https://juejin.cn/post/6844904001444511758
3. 
...
[1]:  #1springcloud
[2]:  #2springcloudoverview
[3]: #3springcloud的服务发现框架——eureka
[4]: #4负载均衡之ribbon
